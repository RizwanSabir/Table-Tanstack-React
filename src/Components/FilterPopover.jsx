...
const StatusItem = ({ status, setColumnFilters, isActive }) => (
  <div
    className={`flex items-center cursor-pointer rounded-lg font-bold p-2 ${isActive ? "text-orange-500" : "bg-transparent"
...
const FilterPopover = ({ columnFilters, setColumnFilters }) => {
  ...
  return (
    <div className="relative" ref={popoverRef}>
      ...
      {isOpen && (
        <div className="absolute top-full left-0 mt-2 w-60 bg-white border-2 border-orange-500 text-black rounded-lg shadow-lg z-20">
          <div className="p-4">
